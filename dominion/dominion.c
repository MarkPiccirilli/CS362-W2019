...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      adventurer_fxn(state, currentPlayer, temphand);
      return 0;
			
    case council_room:
	council_room_fxn(state, handPos, currentPlayer);
	return 0;
    ...
    case smithy:
      smithy_fxn(state, handPos, currentPlayer);
      return 0;
		
    case village:
      village_fxn(state, handPos, currentPlayer);
      return 0;
    ...
    case great_hall:
	great_hall_fxn(state, handPos, currentPlayer);
	return 0;
